...
create_clock -name D_CLK -period 10.0 [get_pins u_ibert_core/inst/SYSCLK_DIVIDER.U_GT_MMCM/CLKOUT0]
set_false_path -from [get_clocks J_CLK] -to [get_clocks D_CLK]
set_false_path -from [get_clocks D_CLK] -to [get_clocks J_CLK]

##
## TX/RX out clock constraints
##
# GT X0Y8
create_clock -name Q2_RXCLK0 -period 3.104 [get_pins {u_ibert_core/inst/QUAD[0].u_q/u_common/u_clocking/rx_ind.NON_K7.u_rxusr0/O}]
set_false_path -from [get_clocks Q2_RXCLK0] -to [get_clocks D_CLK]
set_false_path -from [get_clocks D_CLK] -to [get_clocks Q2_RXCLK0]
create_clock -name  Q2_TX0 -period 3.104 [get_pins {u_ibert_core/inst/QUAD[0].u_q/u_common/u_clocking/local_txusr.NON_K7.u_txusr/O}]
set_false_path -from [get_clocks Q2_TX0] -to [get_clocks D_CLK]
set_false_path -from [get_clocks D_CLK] -to [get_clocks Q2_TX0]
# GT X0Y9
create_clock -name Q2_RXCLK1 -period 3.104 [get_pins {u_ibert_core/inst/QUAD[0].u_q/u_common/u_clocking/rx_ind.NON_K7.u_rxusr1/O}]
set_false_path -from [get_clocks Q2_RXCLK1] -to [get_clocks D_CLK]
set_false_path -from [get_clocks D_CLK] -to [get_clocks Q2_RXCLK1]
# GT X0Y10
create_clock -name Q2_RXCLK2 -period 3.104 [get_pins {u_ibert_core/inst/QUAD[0].u_q/u_common/u_clocking/rx_ind.NON_K7.u_rxusr2/O}]
set_false_path -from [get_clocks Q2_RXCLK2] -to [get_clocks D_CLK]
set_false_path -from [get_clocks D_CLK] -to [get_clocks Q2_RXCLK2]
# GT X0Y11
create_clock -name Q2_RXCLK3 -period 3.104 [get_pins {u_ibert_core/inst/QUAD[0].u_q/u_common/u_clocking/rx_ind.NON_K7.u_rxusr3/O}]
set_false_path -from [get_clocks Q2_RXCLK3] -to [get_clocks D_CLK]
set_false_path -from [get_clocks D_CLK] -to [get_clocks Q2_RXCLK3]

##
## System clock pin locs and timing constraints
##
create_clock -name sysclk_int -period 6.4 [get_pins u_ibert_core/inst/SYSCLK_DIVIDER.U_GT_MMCM/CLKIN1]
...
##
## GTHE2 Channel and Common Loc constraints
##
...
set_clock_groups -group [get_clocks sysclk*] -group [get_clocks Q*_TX*] -asynchronous
set_clock_groups -group [get_clocks Q*_RXCLK*] -group [get_clocks sysclk*] -asynchronous
