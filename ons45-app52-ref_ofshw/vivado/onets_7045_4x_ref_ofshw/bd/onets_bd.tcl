...
proc create_root_design { parentCell } {
 ...
 # Create instance: processing_system7_0, and set properties
  ...
  set_property -dict [ list CONFIG.PHY_TYPE {RGMII} CONFIG.Statistics_Counters {true} CONFIG.Statistics_Reset {false} CONFIG.Statistics_Width {32bit}  ] $axi_ethernet_0
  ...
  set_property -dict [ list CONFIG.PHY_TYPE {RGMII} CONFIG.Statistics_Counters {true} CONFIG.Statistics_Reset {false} CONFIG.Statistics_Width {32bit} CONFIG.SupportLevel {0}  ] $axi_ethernet_1
  ...
  set_property -dict [ list CONFIG.PHY_TYPE {RGMII} CONFIG.Statistics_Counters {true} CONFIG.Statistics_Reset {false} CONFIG.Statistics_Width {32bit} CONFIG.SupportLevel {0}  ] $axi_ethernet_2
  ...
  set_property -dict [ list CONFIG.PHY_TYPE {RGMII} CONFIG.Statistics_Counters {true} CONFIG.Statistics_Reset {false} CONFIG.Statistics_Width {32bit} CONFIG.SupportLevel {0}  ] $axi_ethernet_3
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {6}  ] $concat_int
  ...
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txc0_axis [get_bd_intf_pins dma2eth_intercon_0/m_txc0_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_ctrl_0]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txc1_axis [get_bd_intf_pins dma2eth_intercon_0/m_txc1_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_ctrl_1]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txc2_axis [get_bd_intf_pins dma2eth_intercon_0/m_txc2_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_ctrl_2]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txc3_axis [get_bd_intf_pins dma2eth_intercon_0/m_txc3_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_ctrl_3]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txd0_axis [get_bd_intf_pins dma2eth_intercon_0/m_txd0_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_0]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txd1_axis [get_bd_intf_pins dma2eth_intercon_0/m_txd1_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_1]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txd2_axis [get_bd_intf_pins dma2eth_intercon_0/m_txd2_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_2]
  connect_bd_intf_net -intf_net dma2eth_intercon_0_m_txd3_axis [get_bd_intf_pins dma2eth_intercon_0/m_txd3_axis] [get_bd_intf_pins packet_pipeline_0/s_axis_mm2s_3]
  ...
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_0 [get_bd_intf_pins eth2dma_intercon_0/s_rxd0_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_0]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_1 [get_bd_intf_pins eth2dma_intercon_0/s_rxd1_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_1]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_2 [get_bd_intf_pins eth2dma_intercon_0/s_rxd2_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_2]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_3 [get_bd_intf_pins eth2dma_intercon_0/s_rxd3_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_3]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_sts_0 [get_bd_intf_pins eth2dma_intercon_0/s_rxs0_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_sts_0]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_sts_1 [get_bd_intf_pins eth2dma_intercon_0/s_rxs1_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_sts_1]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_sts_2 [get_bd_intf_pins eth2dma_intercon_0/s_rxs2_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_sts_2]
  connect_bd_intf_net -intf_net packet_pipeline_0_m_axis_s2mm_sts_3 [get_bd_intf_pins eth2dma_intercon_0/s_rxs3_axis] [get_bd_intf_pins packet_pipeline_0/m_axis_s2mm_sts_3]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_ethernet_0/axi_rxd_arstn] [get_bd_pins axi_ethernet_0/axi_rxs_arstn] [get_bd_pins axi_ethernet_0/axi_txc_arstn] [get_bd_pins axi_ethernet_0/axi_txd_arstn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_1/axi_rxd_arstn] [get_bd_pins axi_ethernet_1/axi_rxs_arstn] [get_bd_pins axi_ethernet_1/axi_txc_arstn] [get_bd_pins axi_ethernet_1/axi_txd_arstn] [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins axi_ethernet_2/axi_rxd_arstn] [get_bd_pins axi_ethernet_2/axi_rxs_arstn] [get_bd_pins axi_ethernet_2/axi_txc_arstn] [get_bd_pins axi_ethernet_2/axi_txd_arstn] [get_bd_pins axi_ethernet_2/s_axi_lite_resetn] [get_bd_pins axi_ethernet_3/axi_rxd_arstn] [get_bd_pins axi_ethernet_3/axi_rxs_arstn] [get_bd_pins axi_ethernet_3/axi_txc_arstn] [get_bd_pins axi_ethernet_3/axi_txd_arstn] [get_bd_pins axi_ethernet_3/s_axi_lite_resetn] [get_bd_pins axi_ic_gp/ARESETN] [get_bd_pins axi_ic_gp/M00_ARESETN] [get_bd_pins axi_ic_gp/M01_ARESETN] [get_bd_pins axi_ic_gp/M02_ARESETN] [get_bd_pins axi_ic_gp/M03_ARESETN] [get_bd_pins axi_ic_gp/M04_ARESETN] [get_bd_pins axi_ic_gp/M05_ARESETN] [get_bd_pins axi_ic_gp/M06_ARESETN] [get_bd_pins axi_ic_gp/M07_ARESETN] [get_bd_pins axi_ic_gp/M08_ARESETN] [get_bd_pins axi_ic_gp/S00_ARESETN] [get_bd_pins axi_ic_hp/ARESETN] [get_bd_pins axi_ic_hp/M00_ARESETN] [get_bd_pins axi_ic_hp/S00_ARESETN] [get_bd_pins axi_ic_hp/S01_ARESETN] [get_bd_pins axi_ic_hp/S02_ARESETN] [get_bd_pins dma2eth_intercon_0/aresetn] [get_bd_pins eth2dma_intercon_0/aresetn] [get_bd_pins packet_pipeline_0/s_axi_lite_aresetn] [get_bd_pins packet_pipeline_0/s_axis_mm2s_aresetn] [get_bd_pins packet_pipeline_0/s_axis_rxd_aresetn] [get_bd_pins packet_pipeline_0/s_axis_s2mm_aresetn] [get_bd_pins packet_pipeline_0/s_axis_txd_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets proc_sys_reset_0_peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports bd_fclk0_125m] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins axi_ethernet_2/axis_clk] [get_bd_pins axi_ethernet_3/axis_clk] [get_bd_pins axi_ic_hp/ACLK] [get_bd_pins axi_ic_hp/M00_ACLK] [get_bd_pins axi_ic_hp/S00_ACLK] [get_bd_pins axi_ic_hp/S01_ACLK] [get_bd_pins axi_ic_hp/S02_ACLK] [get_bd_pins dma2eth_intercon_0/aclk] [get_bd_pins eth2dma_intercon_0/aclk] [get_bd_pins packet_pipeline_0/s_axis_mm2s_aclk] [get_bd_pins packet_pipeline_0/s_axis_rxd_aclk] [get_bd_pins packet_pipeline_0/s_axis_s2mm_aclk] [get_bd_pins packet_pipeline_0/s_axis_txd_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
