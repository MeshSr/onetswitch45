...
import_files $ip_proj_root/src/core/eth_queue/eth_queue.v
import_files $ip_proj_root/src/core/eth_queue/eth_queue_regs.v
import_files $ip_proj_root/src/core/eth_queue/pulse_synchronizer.v
import_files $ip_proj_root/src/core/eth_queue/rx_queue.v
import_files $ip_proj_root/src/core/eth_queue/tx_queue.v
import_files $ip_proj_root/src/core/reg_bus/axi_to_reg_bus.v
import_files $ip_proj_root/src/core/reg_bus/reg_grp.v
import_files $ip_proj_root/src/core/reg_bus/udp_reg_path_decode.v
import_files $ip_proj_root/src/core/utils/small_fifo.v
import_files $ip_proj_root/src/core/utils/unused_reg.v
import_files $ip_proj_root/src/meter_lite/meter_lite.v
import_files $ip_proj_root/src/udp_of/in_arb_regs.v
import_files $ip_proj_root/src/udp_of/input_arbiter.v
import_files $ip_proj_root/src/udp_of/opl_processor.v
import_files $ip_proj_root/src/udp_of/output_port_lookup.v
import_files $ip_proj_root/src/udp_of/output_queues.v
import_files $ip_proj_root/src/udp_of/tcam_parallel_matcher.v
import_files $ip_proj_root/src/udp_of/udp_reg_master.v
import_files $ip_proj_root/src/udp_of/unencoded_cam_lut_sm.v
import_files $ip_proj_root/src/udp_of/user_data_path.v
import_files $ip_proj_root/src/udp_of/vlan_adder.v
import_files $ip_proj_root/src/udp_of/vlan_remover.v
import_files $ip_proj_root/src/udp_of/include/onet_defines.v
import_files $ip_proj_root/src/udp_of/lookups/wildcard_match.v
import_files $ip_proj_root/src/udp_of/meter_lite/queue_aggr.v
import_files $ip_proj_root/src/udp_of/meter_lite/queue_splitter.v
import_files $ip_proj_root/src/udp_of/meter_lite/rate_limiter.v
import_files $ip_proj_root/src/udp_of/meter_lite/rate_limiter_regs.v
import_files $ip_proj_root/src/udp_of/preprocessor/header_parser.v
import_files $ip_proj_root/src/udp_of/utils/fallthrough_small_fifo_v2.v
import_files $ip_proj_root/src/udp_of/utils/generic_cntr_regs.v
import_files $ip_proj_root/src/udp_of/utils/generic_hw_regs.v
import_files $ip_proj_root/src/udp_of/utils/generic_regs.v
import_files $ip_proj_root/src/udp_of/utils/generic_sw_regs.v
import_files $ip_proj_root/src/data_fifo.v

update_compile_order -fileset sources_1
update_compile_order -fileset sim_1

set file "include/onet_defines.v"
