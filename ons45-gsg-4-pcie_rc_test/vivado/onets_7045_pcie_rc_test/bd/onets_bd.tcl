...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set bd_ext_rstn [ create_bd_port -dir I -type rst bd_ext_rstn ]
  ...
  set bd_sys_rstn [ create_bd_port -dir O -from 0 -to 0 -type rst bd_sys_rstn ]
  set pcie_dbg_clk [ create_bd_port -dir O pcie_dbg_clk ]
  ...
  set_property -dict [ list CONFIG.BAR0_SCALE {Gigabytes} CONFIG.BAR0_SIZE {1} CONFIG.BAR_64BIT {false} CONFIG.COMP_TIMEOUT {50ms} CONFIG.ENABLE_CLASS_CODE {true} CONFIG.INCLUDE_RC {Root_Port_of_PCI_Express_Root_Complex} CONFIG.MAX_LINK_SPEED {5.0_GT/s} CONFIG.NUM_MSI_REQ {0} CONFIG.PCIE_CAP_SLOT_IMPLEMENTED {true} CONFIG.SUB_CLASS_INTERFACE_MENU {PCI_to_PCI_bridge} CONFIG.S_AXI_SUPPORTS_NARROW_BURST {true}  ] $axi_pcie_0
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {1}  ] $concat_int
  ...
  connect_bd_intf_net -intf_net axi_ic_gp_s_M00_AXI [get_bd_intf_pins axi_ic_hp_s/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_ic_gp_m/M00_AXI] [get_bd_intf_pins axi_pcie_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_ic_gp_m/M01_AXI] [get_bd_intf_pins axi_pcie_0/S_AXI_CTL]
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_ports pcie_dbg_clk] [get_bd_pins axi_ic_gp_m/M00_ACLK] [get_bd_pins axi_ic_hp_s/S00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk] [get_bd_pins axi_pcie_0/axi_aclk_out]
  connect_bd_net -net axi_pcie_0_axi_ctl_aclk_out [get_bd_pins axi_ic_gp_m/M01_ACLK] [get_bd_pins axi_pcie_0/axi_ctl_aclk] [get_bd_pins axi_pcie_0/axi_ctl_aclk_out]
  connect_bd_net -net axi_pcie_0_interrupt_out [get_bd_pins axi_pcie_0/interrupt_out] [get_bd_pins concat_int/In0]
  connect_bd_net -net axi_pcie_0_mmcm_lock [get_bd_ports pcie_dbg_mmcm_lock] [get_bd_pins axi_pcie_0/mmcm_lock] [get_bd_pins concat_dcmlock/In3]
