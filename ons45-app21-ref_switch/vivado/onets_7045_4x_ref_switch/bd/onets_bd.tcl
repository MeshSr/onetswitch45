...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {4}  ] $concat_int
  ...
  # Create instance: ref_switch_core_0, and set properties
  set ref_switch_core_0 [ create_bd_cell -type ip -vlnv meshsr:user:ref_switch_core:1.0 ref_switch_core_0 ]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_0_m_axis_rxd [get_bd_intf_pins axi_ethernet_0/m_axis_rxd] [get_bd_intf_pins ref_switch_core_0/s_axis_rxd_0]
  connect_bd_intf_net -intf_net axi_ethernet_0_m_axis_rxs [get_bd_intf_pins axi_ethernet_0/m_axis_rxs] [get_bd_intf_pins ref_switch_core_0/s_axis_rxs_0]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_1_m_axis_rxd [get_bd_intf_pins axi_ethernet_1/m_axis_rxd] [get_bd_intf_pins ref_switch_core_0/s_axis_rxd_1]
  connect_bd_intf_net -intf_net axi_ethernet_1_m_axis_rxs [get_bd_intf_pins axi_ethernet_1/m_axis_rxs] [get_bd_intf_pins ref_switch_core_0/s_axis_rxs_1]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_2_m_axis_rxd [get_bd_intf_pins axi_ethernet_2/m_axis_rxd] [get_bd_intf_pins ref_switch_core_0/s_axis_rxd_2]
  connect_bd_intf_net -intf_net axi_ethernet_2_m_axis_rxs [get_bd_intf_pins axi_ethernet_2/m_axis_rxs] [get_bd_intf_pins ref_switch_core_0/s_axis_rxs_2]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_3_m_axis_rxd [get_bd_intf_pins axi_ethernet_3/m_axis_rxd] [get_bd_intf_pins ref_switch_core_0/s_axis_rxd_3]
  connect_bd_intf_net -intf_net axi_ethernet_3_m_axis_rxs [get_bd_intf_pins axi_ethernet_3/m_axis_rxs] [get_bd_intf_pins ref_switch_core_0/s_axis_rxs_3]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins ref_switch_core_0/s_axi_lite]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net s_axi_1 [get_bd_intf_pins axi_ethernet_0/s_axi] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net s_axi_2 [get_bd_intf_pins axi_ethernet_1/s_axi] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net s_axi_3 [get_bd_intf_pins axi_ethernet_2/s_axi] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net s_axi_4 [get_bd_intf_pins axi_ethernet_3/s_axi] [get_bd_intf_pins axi_interconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net s_axis_txc_1 [get_bd_intf_pins axi_ethernet_0/s_axis_txc] [get_bd_intf_pins ref_switch_core_0/m_axis_txc_0]
  connect_bd_intf_net -intf_net s_axis_txc_2 [get_bd_intf_pins axi_ethernet_1/s_axis_txc] [get_bd_intf_pins ref_switch_core_0/m_axis_txc_1]
  connect_bd_intf_net -intf_net s_axis_txc_3 [get_bd_intf_pins axi_ethernet_2/s_axis_txc] [get_bd_intf_pins ref_switch_core_0/m_axis_txc_2]
  connect_bd_intf_net -intf_net s_axis_txc_4 [get_bd_intf_pins axi_ethernet_3/s_axis_txc] [get_bd_intf_pins ref_switch_core_0/m_axis_txc_3]
  connect_bd_intf_net -intf_net s_axis_txd_1 [get_bd_intf_pins axi_ethernet_0/s_axis_txd] [get_bd_intf_pins ref_switch_core_0/m_axis_txd_0]
  connect_bd_intf_net -intf_net s_axis_txd_2 [get_bd_intf_pins axi_ethernet_1/s_axis_txd] [get_bd_intf_pins ref_switch_core_0/m_axis_txd_1]
  connect_bd_intf_net -intf_net s_axis_txd_3 [get_bd_intf_pins axi_ethernet_2/s_axis_txd] [get_bd_intf_pins ref_switch_core_0/m_axis_txd_2]
  connect_bd_intf_net -intf_net s_axis_txd_4 [get_bd_intf_pins axi_ethernet_3/s_axis_txd] [get_bd_intf_pins ref_switch_core_0/m_axis_txd_3]
  ...
  connect_bd_net -net ext_rst_1 [get_bd_ports ext_rst] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_ethernet_0/axi_rxd_arstn] [get_bd_pins axi_ethernet_0/axi_rxs_arstn] [get_bd_pins axi_ethernet_0/axi_txc_arstn] [get_bd_pins axi_ethernet_0/axi_txd_arstn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_1/axi_rxd_arstn] [get_bd_pins axi_ethernet_1/axi_rxs_arstn] [get_bd_pins axi_ethernet_1/axi_txc_arstn] [get_bd_pins axi_ethernet_1/axi_txd_arstn] [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins axi_ethernet_2/axi_rxd_arstn] [get_bd_pins axi_ethernet_2/axi_rxs_arstn] [get_bd_pins axi_ethernet_2/axi_txc_arstn] [get_bd_pins axi_ethernet_2/axi_txd_arstn] [get_bd_pins axi_ethernet_2/s_axi_lite_resetn] [get_bd_pins axi_ethernet_3/axi_rxd_arstn] [get_bd_pins axi_ethernet_3/axi_rxs_arstn] [get_bd_pins axi_ethernet_3/axi_txc_arstn] [get_bd_pins axi_ethernet_3/axi_txd_arstn] [get_bd_pins axi_ethernet_3/s_axi_lite_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ref_switch_core_0/axis_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txc_0_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txc_1_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txc_2_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txc_3_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txd_0_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txd_1_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txd_2_aresetn] [get_bd_pins ref_switch_core_0/m_axis_txd_3_aresetn] [get_bd_pins ref_switch_core_0/s_axi_lite_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxd_0_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxd_1_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxd_2_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxd_3_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxs_0_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxs_1_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxs_2_aresetn] [get_bd_pins ref_switch_core_0/s_axis_rxs_3_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports bd_fclk0_125m] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins axi_ethernet_2/axis_clk] [get_bd_pins axi_ethernet_3/axis_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ref_switch_core_0/axis_aclk] [get_bd_pins ref_switch_core_0/m_axis_txc_0_aclk] [get_bd_pins ref_switch_core_0/m_axis_txc_1_aclk] [get_bd_pins ref_switch_core_0/m_axis_txc_2_aclk] [get_bd_pins ref_switch_core_0/m_axis_txc_3_aclk] [get_bd_pins ref_switch_core_0/m_axis_txd_0_aclk] [get_bd_pins ref_switch_core_0/m_axis_txd_1_aclk] [get_bd_pins ref_switch_core_0/m_axis_txd_2_aclk] [get_bd_pins ref_switch_core_0/m_axis_txd_3_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxd_0_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxd_1_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxd_2_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxd_3_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxs_0_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxs_1_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxs_2_aclk] [get_bd_pins ref_switch_core_0/s_axis_rxs_3_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports bd_fclk1_75m] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_1/s_axi_lite_clk] [get_bd_pins axi_ethernet_2/s_axi_lite_clk] [get_bd_pins axi_ethernet_3/s_axi_lite_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ref_switch_core_0/s_axi_lite_aclk]
  ...
  create_bd_addr_seg -range 0x8000000 -offset 0x48000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ref_switch_core_0/s_axi_lite/reg0] SEG_reference_switch_core_0_reg0
