...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_MI {8}  ] $axi_ic_gp
  ...
  connect_bd_intf_net -intf_net axi_dma_2_M_AXIS_CNTRL [get_bd_intf_pins axi_dma_2/M_AXIS_CNTRL] [get_bd_intf_pins axi_ethernet_2/s_axis_txc]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXIS_MM2S [get_bd_intf_pins axi_dma_2/M_AXIS_MM2S] [get_bd_intf_pins axi_ethernet_2/s_axis_txd]
  ...
  connect_bd_intf_net -intf_net axi_dma_3_M_AXIS_CNTRL [get_bd_intf_pins axi_dma_3/M_AXIS_CNTRL] [get_bd_intf_pins axi_ethernet_3/s_axis_txc]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXIS_MM2S [get_bd_intf_pins axi_dma_3/M_AXIS_MM2S] [get_bd_intf_pins axi_ethernet_3/s_axis_txd]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_2_m_axis_rxd [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM] [get_bd_intf_pins axi_ethernet_2/m_axis_rxd]
  connect_bd_intf_net -intf_net axi_ethernet_2_m_axis_rxs [get_bd_intf_pins axi_dma_2/S_AXIS_STS] [get_bd_intf_pins axi_ethernet_2/m_axis_rxs]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_3_m_axis_rxd [get_bd_intf_pins axi_dma_3/S_AXIS_S2MM] [get_bd_intf_pins axi_ethernet_3/m_axis_rxd]
  connect_bd_intf_net -intf_net axi_ethernet_3_m_axis_rxs [get_bd_intf_pins axi_dma_3/S_AXIS_STS] [get_bd_intf_pins axi_ethernet_3/m_axis_rxs]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets axi_dma_0_mm2s_cntrl_reset_out_n]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins concat_int/In4]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets axi_dma_0_mm2s_introut]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets axi_dma_0_mm2s_prmry_reset_out_n]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins concat_int/In5]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets axi_dma_0_s2mm_introut]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets axi_dma_0_s2mm_prmry_reset_out_n]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_nets axi_dma_0_s2mm_sts_reset_out_n]
